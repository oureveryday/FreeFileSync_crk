ifdef RAX
	...
	.stack 4096
	.code
		extern OriginalFuncs:DWORD
		GetFileVersionInfoA proc
			jmp DWORD ptr OriginalFuncs[0 * 4]
		GetFileVersionInfoA endp
		GetFileVersionInfoByHandle proc
			jmp DWORD ptr OriginalFuncs[1 * 4]
		GetFileVersionInfoByHandle endp
		GetFileVersionInfoExA proc
			jmp DWORD ptr OriginalFuncs[2 * 4]
		GetFileVersionInfoExA endp
		GetFileVersionInfoExW proc
			jmp DWORD ptr OriginalFuncs[3 * 4]
		GetFileVersionInfoExW endp
		GetFileVersionInfoSizeA proc
			jmp DWORD ptr OriginalFuncs[4 * 4]
		GetFileVersionInfoSizeA endp
		GetFileVersionInfoSizeExA proc
			jmp DWORD ptr OriginalFuncs[5 * 4]
		GetFileVersionInfoSizeExA endp
		GetFileVersionInfoSizeExW proc
			jmp DWORD ptr OriginalFuncs[6 * 4]
		GetFileVersionInfoSizeExW endp
		GetFileVersionInfoSizeW proc
			jmp DWORD ptr OriginalFuncs[7 * 4]
		GetFileVersionInfoSizeW endp
		GetFileVersionInfoW proc
			jmp DWORD ptr OriginalFuncs[8 * 4]
		GetFileVersionInfoW endp
		VerFindFileA proc
			jmp DWORD ptr OriginalFuncs[9 * 4]
		VerFindFileA endp
		VerFindFileW proc
			jmp DWORD ptr OriginalFuncs[10 * 4]
		VerFindFileW endp
		VerInstallFileA proc
			jmp DWORD ptr OriginalFuncs[11 * 4]
		VerInstallFileA endp
		VerInstallFileW proc
			jmp DWORD ptr OriginalFuncs[12 * 4]
		VerInstallFileW endp
		VerLanguageNameA proc
			jmp DWORD ptr OriginalFuncs[13 * 4]
		VerLanguageNameA endp
		VerLanguageNameW proc
			jmp DWORD ptr OriginalFuncs[14 * 4]
		VerLanguageNameW endp
		VerQueryValueA proc
			jmp DWORD ptr OriginalFuncs[15 * 4]
		VerQueryValueA endp
		VerQueryValueW proc
			jmp DWORD ptr OriginalFuncs[16 * 4]
		VerQueryValueW endp
endif
end